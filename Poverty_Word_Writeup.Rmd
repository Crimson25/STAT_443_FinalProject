...
Method <- c("Full Model", "Stepwise Selection", "Forward Selection", "Backward Selection", "Lasso Regression", "Ridge Regression", "Manual Selection")

Accuracy <- c(full.Accuracy, step.Accuracy, stepforward.Accuracy, stepback.Accuracy, AccuracyLasso, AccuracyRidge, conf.mat.k$overall["Accuracy"])
