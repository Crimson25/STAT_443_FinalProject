...
```{r fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, fig.height=4}
#LASSO testing data classification matrix
library(flextable)
class.tbl_LAS <- data.frame("." = c("Level 1 \nPredicted", "Level 2 \nPredicted", "Level 3 \nPredicted", "Level 4 \nPredicted"), "Level 1 \nTrue" = c(16,13,1,25), "Level 2 \nTrue" = c(6,36,2,72),"Level 3 \nTrue" = c(6,14,6,66),"Level 4 \nTrue" = c(6,12,4,420))

class.ft <- flextable(class.tbl_LAS)
class.ft <- align(class.ft, align = "center", part = "all")
class.ft <- bg(class.ft, bg = "steelblue", part = "header")
class.ft <- bg(class.ft, j= ".", bg = "steelblue", part = "body" )
class.ft <- color(class.ft, color = "white", part = "header")
class.ft <- color(class.ft, j=".", color="white", part= "body")
class.ft <- bold(class.ft, part = "header", bold = TRUE)
class.ft <- bold(class.ft, j = ".", bold = TRUE, part = "body")
class.ft <- set_header_labels(class.ft, . = " ", 
...
```{r fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, fig.height=4}
#SVM testing data classification matrix
class.tbl_SVM <- data.frame("." = c("Level 1 \nPredicted", "Level 2 \nPredicted", "Level 3 \nPredicted", "Level 4 \nPredicted"), "Level 1 \nTrue" = c(55,0,0,0), "Level 2 \nTrue" = c(0,115,0,1),"Level 3 \nTrue" = c(0,0,91,1),"Level 4 \nTrue" = c(0,0,0,442))

class.ft <- flextable(class.tbl_SVM)
class.ft <- align(class.ft, align = "center", part = "all")
class.ft <- bg(class.ft, bg = "steelblue", part = "header")
class.ft <- bg(class.ft, j= ".", bg = "steelblue", part = "body" )
class.ft <- color(class.ft, color = "white", part = "header")
